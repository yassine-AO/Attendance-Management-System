    ...
    <div class="row">
        <div class="col-md-6 mb-4">
            <div class="card">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">{{$prof->id}}</li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-md-6 mb-4">
            <div class="card">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">{{$prof->nom}}</li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-md-6 mb-4">
            <div class="card">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">{{$prof->prenom}}</li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-md-6 mb-4">
            <div class="card">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">{{$module->nom}}/{{$module->annee_section->nom}}/{{$module->annee_section->filiere->nom}}/{{$module->annee_section->filiere->campus->nom}}</li>
                    @endforeach
