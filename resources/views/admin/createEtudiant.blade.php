...
<form action="{{ route('admin.storeEtudiant', $admin->id) }}" method="POST">
    @csrf
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="prenom" name="prenom" style="width: 300px;">
    </div>
    ...
    <div class="mb-3">
        ...
        <input type="tel" class="form-control" id="telephone" name="telephone" style="width: 300px;">
    </div>
