...
.main-content {
  margin-top: 200px; /* Adjust as needed to prevent overlap */
}
  </style>
</head>
...
<div class="container-fluid d-flex justify-content-center align-items-center background main-content">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title" style="font-size: 1.2rem;">
                                    <u>{{$prof->nom}} , {{$prof->prenom}}</u>
                                </h5>
                                <p class="card-text">Campus: {{$module->annee_section->filiere->campus->nom}}</p>
                                <p class="card-text">Adresse email: {{$prof->email}}</p>
                                @foreach ($modules as $prfmdl )
                                 <p class="card-text">Module:{{$prfmdl->nom}}</p>
                                @endforeach
                                @foreach ($absences as $absence )
                                 <p class="card-text">Absence:{{$absence->motif}} | {{$absence->module->nom}} </p>
                                @endforeach
